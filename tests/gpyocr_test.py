...
image_path = os.path.abspath(
    resource_filename("tests.resources", "european-test.png")
)
tess_out_empty = os.path.abspath(
    resource_filename("tests.resources", "tess_out_empty.tsv")
)
tess_out = os.path.abspath(
    resource_filename("tests.resources", "tess_out.tsv")
)
tess_out_whitelist = os.path.abspath(
    resource_filename("tests.resources", "tess_out_whitelist.tsv")
)
